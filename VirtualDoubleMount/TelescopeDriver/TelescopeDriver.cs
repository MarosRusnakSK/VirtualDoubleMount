...
//
// ASCOM Telescope driver for MRVirtual
//
...
namespace ASCOM.MRVirtual.Telescope
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.MRVirtual.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.MRVirtual.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _MRVirtual from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("b77e41b0-7a35-4a02-b025-e880fb79c4d9")]
    [ProgId("ASCOM.MRVirtual.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for MRVirtual")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MRVirtual"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "MRVirtual.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.MRVirtual.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
